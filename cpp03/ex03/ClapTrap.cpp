...
/*   Updated: 2023/11/27 13:53:21 by njantsch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string& target)
{
	if (this->hitPoints > 0 && this->energyPoints > 0) {
		std::cout << "ClapTrap: " << this->name << " used attack on " << target << " !" << std::endl;
		this->energyPoints--;
	}
	else if (this->hitPoints == 0)
		std::cout << "ClapvTrap: " << this->name << " is lacking Hit Points to attack" << std::endl;
	else if (this->energyPoints == 0)
		std::cout << "ClapTrap: " << this->name << " is lacking Energy Points to attack" << std::endl;
}
